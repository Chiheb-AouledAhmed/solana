...
var fs_1 = require("fs");
var writeFilePromise = (0, promise_1.promisify)(fs_1.writeFile);
var DEFAULT_ENCODING = 'utf8';
var UTF8_BOM = '\uFEFF';
var FileWriter = /** @class */ (function () {
    function FileWriter(path, append, encoding, useBom) {
    ...
    FileWriter.prototype.write = function (string) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        content = this.useBom && !this.append ? UTF8_BOM + string : string;
                        return [4 /*yield*/, writeFilePromise(this.path, content, this.getWriteOption())];
                    case 1:
                        _a.sent();
                        this.append = true;
                        return [2 /*return*/];
