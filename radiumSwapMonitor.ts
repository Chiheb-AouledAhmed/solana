...
async function processLogEvent(connection: Connection, logsInfo: any, logStream: fs.WriteStream) {
...
async function processQueue(connection: Connection, logStream: fs.WriteStream) {
