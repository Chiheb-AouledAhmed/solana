...
exports.AnalyseCommonAddressesTransactions = AnalyseCommonAddressesTransactions;
...
async function AnalyseCommonAddressesTransactions(tokenAddress, lastSignature, filename) {
    ...
    try {
        ...
        for (const account of ignoredAddresses) {
            watchedAccounts.push(new web3_js_1.PublicKey(account));
        }
...
//# sourceMappingURL=AnalyseCommonAddresses.js.map